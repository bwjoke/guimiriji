 ...
 */
@property (nonatomic, unsafe_unretained) id<RMStoreReceiptVerificator> receiptVerificator;
 ...
 */
@property (nonatomic, unsafe_unretained) id<RMStoreTransactionObfuscator> transactionObfuscator;
