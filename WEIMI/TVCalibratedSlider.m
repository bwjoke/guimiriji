...
- (id)initWithFrame:(CGRect)frame {
    frame = CGRectMake(10, 10, 300, 130);
...
- (void)initializeSlider {
    ...
    _tvSliderView = [[[TVSlider alloc] initWithFrame:CGRectMake(0, 50, self.frame.size.width,30)] autorelease];
    _tvSliderView.continuous = YES;
...
- (void)setStyle:(TVCalibratedSliderStyle)style {
    ...
    if(style == TavicsaStyle) {
        [self setMaximumTrackImage:@"slider_gray_1" withCapInsets:UIEdgeInsetsMake(0, 20, 0, 20) forState:UIControlStateNormal];
        [self setMinimumTrackImage:@"slider_gray_1" withCapInsets:UIEdgeInsetsMake(0, 20, 0, 0) forState:UIControlStateNormal];
        [self setThumbImage:@"slider_normal_1" forState:UIControlStateNormal withOffsetRelativeToCenterOfTrack:CGPointMake(0, -15)];
        [self setThumbImage:@"slider_hover_1" forState:UIControlStateHighlighted withOffsetRelativeToCenterOfTrack:CGPointMake(0, -27)];
    }
}
...
- (NSString *)valueString {
    return _tvSliderView.valueString;
}
