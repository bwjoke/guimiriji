//
//  WMAddBaoliaoPseudoViewController.m
//  WEIMI
//
...
@interface WMAddBaoliaoPseudoViewController ()
{
...
@implementation WMAddBaoliaoPseudoViewController
...
-(void)rightButtonClick:(id)sender{
    ...
    [[WMManService sharedWMManService] addBaoliaoWithMID:@"weimiman" content:self.content purview:(self.selectedIndex+1)%3 picture:self.image?UIImageJPEGRepresentation(self.image, 0.5):nil andRequestDelegate:rd];
...
//    [questionList addObjectsFromArray:[self parseArray:questions]];
    ...
    _textField.placeholderLabel.text = @"";
...
//    self.askButtn = [[[UIButton alloc] initWithFrame:CGRectMake(103, 10, 81, 81)] autorelease];
