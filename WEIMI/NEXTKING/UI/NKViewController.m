...
-(UIButton*)addBackButton{
   ...
   // UIImage *highlight = [[UIImage imageNamed:@"topButton_click.png"] resizeImageWithCapInsets:UIEdgeInsetsMake(15, 15, 15, 15)];
    ...
    [button setImage:[UIImage imageNamed:@"backbutton_normal.png"] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"backbutton_click.png"] forState:UIControlStateHighlighted];
...
-(UIButton *)addbackButtonWithImages:(id)images
{
    ...
    if ([images isKindOfClass:[NSString class]]) {
        ...
        [button setImage:[images objectAtIndex:1] forState:UIControlStateHighlighted];
        button.frame = CGRectMake(0, 0, 55, 43);
    }
...
-(UIButton*)addRightButtonWithTitle:(id)title{
    ...
    if ([title isKindOfClass:[NSString class]]) {
        [button setTitle:title forState:UIControlStateNormal];
        CGFloat width = [title sizeWithFont:[UIFont systemFontOfSize:14] constrainedToSize:CGSizeMake(80, 14) lineBreakMode:NSLineBreakByCharWrapping].width;
        button.frame = CGRectMake(320-26-width, 0, width+26, 43);
    }
    else if ([title isKindOfClass:[NSArray class]]){
        [button setImage:[title objectAtIndex:0] forState:UIControlStateNormal];
        [button setImage:[title objectAtIndex:1] forState:UIControlStateHighlighted];
