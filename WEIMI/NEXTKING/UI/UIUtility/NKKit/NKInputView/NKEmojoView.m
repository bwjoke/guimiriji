...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSArray *emojos = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:[[NKConfig sharedConfig] emojoPlist] ofType:@"plist"]];
        ...
        for (int i=0; i<[emojos count]; i++) {
            ...
            [emojoButton setBackgroundImage:[UIImage imageNamed:emojoPad[@"emojoback"]] forState:UIControlStateHighlighted];
