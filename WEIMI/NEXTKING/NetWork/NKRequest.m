        ...
        if ((incomingrequest.responseStatusCode == 200 || incomingrequest.responseStatusCode == 304) && [tServerError intValue]==[[NKConfig sharedConfig] successReturnValue]) {
            ...
            switch (self.resultType) {
                ...
                case NKResultTypeDeapArray:{
                    ...
                    resultsArray = [NSMutableArray arrayWithCapacity:[(NSArray*)realSomething count]];
                ...
                case NKResultTypeResultSets:{
                    self.totalCount = [realSomething objectOrNilForKey:[[NKConfig sharedConfig] totalCountKey]];
                    // Special
                    if (!self.totalCount) {
                    ...
                    self.hasMore = [realSomething objectOrNilForKey:@"has_more"];
